...
- [x] 05-05-PLAN.md — Mount footer + tease, deploy, curl probes, LinkedIn Post Inspector + waitlist row human-verify
...
- [x] 07-10-PLAN.md — Launch deploy: optional domain/Clerk production cut-over, live probes, final Lighthouse run, LinkedIn Post Inspector re-scrape + phone open
