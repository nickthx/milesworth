...
- [x] **RANK-03**: Each result is tagged with which of the user's balances it uses, showing the cheapest transfer path when multiple programs reach the same partner
- [x] **RANK-04**: Each result shows its transfer path explicitly (e.g., "via Chase UR → World of Hyatt 1:1")
- [x] **RANK-05**: Each result includes short how-to-book guidance (2–4 lines, curated)
...
- [x] **ACCT-02**: Signed-in user can bookmark redemptions they're working toward
- [x] **ACCT-03**: Signed-in user can record travel goals (stored only; no v1 ranking effect)
...
- [x] **PLAT-02**: App is fully responsive and works in the LinkedIn in-app browser (mobile WebView tested before launch)
...
- [x] **PLAT-05**: Editorial travel design system (light, magazine-like, destination imagery, big numbers) applied across all pages
